...
const { clientId, clientSecret, authorizationURL, callbackURL, accessTokenURL } = require('../config');
...
class API {
    ...
    static getAuthorizationUrl() {
        ...
        const url = `${authorizationURL}?response_type=code&client_id=${clientId}&redirect_uri=${encodeURIComponent(callbackURL)}&state=${state}&scope=${scope}`;
        return url;
    }
}
